...
df_= pd.read_csv("C:/Users/aligi/OneDrive/Masaüstü/RFM_segmentation/flo_data_20k.csv")
df = df_.copy()
...
# Tarih ifade eden değişkenlerin tipini date'e çeviriyoruz.
...
# Oluşturulan RFM skorların daha açıklanabilir olması için segment tanımladık ve  rf_score segmentlere çevirdik
...
#RFM analizi yardımı ile 2 case için ilgili profildeki müşterileri bulunuz ve müşteri id'lerini csv ye kaydediniz.
